          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(image: NetworkImage('https://baliuntold.com/wp-content/uploads/2024/06/Merlins-Ubud-restaurant.jpg'),fit: BoxFit.cover),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                   Icon(Icons.flash_on, color:AppColors.warning900, size: 18),
                      const SizedBox(width: 6),
                      Text("Available on fast delivery", style: textTheme.bodySmall),
                    ],
                  ),
                  const SizedBox(height: 8),
                  Text(widget.restaurantName, style: textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold)),
                  const SizedBox(height: 6),
                  Row(
                    children: [
                       Icon(Icons.favorite, size: 16, color:AppColors.primary900),
                      const SizedBox(width: 4),
                      Text("Bali, Indonesia", style: textTheme.bodyMedium),
                      const SizedBox(width: 12),
                      Icon(Icons.location_on, size: 16,color:AppColors.primary900),
                      const SizedBox(width: 4),
            ...
            Padding(
              padding: EdgeInsets.symmetric(horizontal: size.width * 0.04),
              child: Text("All Restaurants", style: textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
            ),
